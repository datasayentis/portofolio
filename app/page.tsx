      ...
      <section className="mb-16">
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <p className="text-gray-800 mb-4">
              my other project about system information, developing a decision
              support system, with CRUD feature.
            </p>
            {/* Technologies */}
            <div className="flex flex-wrap gap-2">
              <div className="border border-gray-200 px-2 py-1 text-sm rounded-sm">
          ...
          <div>
            <h3 className="font-medium flex items-center gap-2">
              TrophyHUB ERP Apps
              <Link
                href="https://github.com/datasayentis/TrophyHUB"
                className="inline-flex items-center text-sm underline text-blue-600 hover:text-blue-400"
              >
                <span>View Project</span>
                <ExternalLink size={16} />
            ...
            <p className="text-gray-800 mb-4">
              TrophyHUB, is a web-based Enterprise Resource Planning (ERP)
              system developed as a final assignment for my 7th-semester ERP
              course. Built with Laravel and utilizing MySQL for data
              management, TrophyHUB focuses specifically on streamlining and
              managing production processes. TrophyHUB integrates several core
              functionalities, including: Product Module, Material Module, Bills
              Of Material (BoM) Module, and Manufacturing Order Module.
            </p>
            {/* Technologies */}
            <div className="flex flex-wrap gap-2">
              <div className="border border-gray-200 px-2 py-1 text-sm rounded-sm">
          ...
          <div>
            <h3 className="font-medium flex items-center gap-2">
              Information System Mapping (SI-LPMK)
              <Link
                href="https://github.com/diimprasetyos/lpmk"
                className="inline-flex items-center text-sm underline text-blue-600 hover:text-blue-400"
              >
                <span>View Project</span>
                <ExternalLink size={16} />
            ...
            <p className="text-gray-800 mb-4">
              SI-LPMK is an information system mapping project built with
              Laravel and MySQL. It features comprehensive CRUD (Create, Read,
              Update, Delete) operations, secure login authentication, and
              robust user role management to control access and permissions
              within the system.
            </p>
            {/* Technologies */}
            <div className="flex flex-wrap gap-2">
